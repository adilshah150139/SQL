...
COPY company_dim
From 'E:\SQL\SQL_PROJECTS_DATA_JOB\csv_files\company_dim.csv'
...
From 'E:\SQL\SQL_PROJECTS_DATA_JOB\csv_files\job_postings_fact.csv'
DELIMITER ',' CSV HEADER;
...
COPY skills_dim
FROM 'E:\SQL\SQL_PROJECTS_DATA_JOB\csv_files\skills_dim.csv'
DELIMITER ',' CSV HEADER
ENCODING 'UTF8'
QUOTE '"';

COPY skills_job_dim
From 'E:\SQL\SQL_PROJECTS_DATA_JOB\csv_files\skills_job_dim.csv'
DELIMITER ',' CSV HEADER
ENCODING 'UTF8'
QUOTE '"';
